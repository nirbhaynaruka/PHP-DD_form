...
<body>
  <header style="height: 80px">
    ...
    <section class="container" style="background-color:ghostwhite;">
  <!-- <div class="container"> -->
    <div>
      <h3 style="text-align: center;margin-bottom: 2%;padding: 3%;background-color: cadetblue;width: 1137px;margin-left: -14px;">DD-Form</h3>
    </div>
    <div class="ddform">
      <form id="ddform">
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="ddno" name="ddno" placeholder="123..." style="width: 50%;">
          </div>
          <div class="form-group col-md-6">
            <label for="date">Date</label>
            <input type="date" class="form-control" id="date" name="date" placeholder="yyyy-mm-dd" style="width: 50%;" >
          </div>
        </div>
        <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="amount" name="amount" placeholder="123...in Rupees" style="width: 50%;">
              </div>
              <div class="form-group col-md-6">
                <label for="bank">Bank</label>
                <input type="text" class="form-control" id="bank" name="bank" placeholder="Bankname" style="width: 50%;">
              </div>
        </div>
        <div class="form-row">
          ...
          <div class="form-group col-md-1">
            <button class="btn btn-primary"  style="margin-top:33%;" type="button" id="addpurp" onclick=addpurphtml('add')>+</button>
          </div>
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-5">
            ...
            <input type="text" class="form-control" id="regno" name="regno" placeholder="RAxxxxx" style="width: 50%;">
          </div>
        </div>
        <div class="form-row">
        ...
        <button type="button" class="btn btn-primary" id="save" style="margin-right: 25px;">Save</button>
